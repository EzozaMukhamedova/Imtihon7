...
const Navbar = () => {
  return (
    ...
    <div className="bg-[#343a40] w-[1440px] m-auto flex items-center justify-between  h-[70px] text-white">
        <div className="flex ">
          <p className="flex items-center text-white">
            <RiCodeSSlashLine  className="w-[25px] h-[25px] font-bold"/>
            <span className="text-[25px] font-[700]"> DevConnector</span>
          </p>
        </div>
        <ul className="flex">
          <li>
            <NavLink to={"/"} className="text-white p-[8px] text-[18px] hover:text-[#17a2b8]">Developers</NavLink>
          </li>
          <li>
